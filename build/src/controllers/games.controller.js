            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (clientWantsJson(request)) {
                        ...
                        response.render("games", { games: games });
                    }
                    return [2 /*return*/];
            }
        });
...
exports.index = index;
function show(gameModel) {
    var _this = this;
    return function (request, response) { return __awaiter(_this, void 0, void 0, function () {
        var game;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, gameModel.findBySlug(request.params.slug)];
                case 1:
                    game = _a.sent();
                    if (game) {
                        if (clientWantsJson(request)) {
