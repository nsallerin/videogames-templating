...
exports.index = index;
function show(platformModel) {
    var _this = this;
    return function (request, response) { return __awaiter(_this, void 0, void 0, function () {
        var platform;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, platformModel.findBySlug(request.params.slug)];
                case 1:
                    platform = _a.sent();
                    if (platform) {
                        if (clientWantsJson(request)) {
                            ...
                            response.render("platform", { platform: platform });
                        }
                    }
                    else {
                        response.status(404);
